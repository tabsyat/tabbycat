...
from .random import RandomPairingMethodMixin
...
class GraphPowerPairedDrawGenerator(RandomPairingMethodMixin, GraphCostMixin, GraphGeneratorMixin, BasePowerPairedDrawGenerator):
    pass


class SingleGraphPowerPairedDrawGenerator(RandomPairingMethodMixin, GraphCostMixin, GraphGeneratorMixin, BasePowerPairedDrawGenerator):
